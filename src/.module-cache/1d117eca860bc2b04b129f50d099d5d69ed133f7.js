...
var Sp = React.createClass({displayName: 'Sp',
	...
	renderList: function(data){
		...
		ret = data.list.map(function(d){
			return (
				React.DOM.li(null, 
					React.DOM.a({href: "javascript:;", 'data-aid': d.aid, title: d.title, onClick: this.getUrl}, 
		...
		ret.push(React.DOM.li(null, "收起全部"))
		return (
			React.DOM.ul(null, 
				ret
			)
		...
		var buildList = function(data){
			...
			return (
				React.DOM.div(null, 
					...
					Sp({data: sp, avs: this.state.avs, resetAvs: this.resetAvs}), 
					Av({data: av}), 
