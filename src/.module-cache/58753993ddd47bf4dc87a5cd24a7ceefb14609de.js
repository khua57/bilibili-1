...
var SuggestList = React.createClass({displayName: 'SuggestList',
	...
	render: function(){
		return (
			React.DOM.ul({className: "suggestList", style: {display: this.state.lists.length ? 'block' : 'none'}}, 
				this.renderList(this.state.lists)
			)
		)
	}
})
var SearchBar = React.createClass({displayName: 'SearchBar',
	...
	render: function(){
		...
		React.DOM.div({className: "row collapse"}, 
			...
			React.DOM.input({type: "text", placeholder: "bilibili...", ref: "searchBar", onInput: this.suggestHandler}), 
