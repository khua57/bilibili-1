			...
			result.forEach(function(d){
				if(d.type === 'video'){
					...
					sp.push(React.DOM.li(null, 
						React.DOM.a({className: "th", href: "javascript:;", 'data-sid': d.sid, onClick: this.getCid}, 
  							React.DOM.img({src: d.pic})
						), 
						React.DOM.div({className: "des"}, 
							React.DOM.h6(null, React.DOM.i({className: "label Warning"}, d.typename), React.DOM.a({href: "http://www.bilibili.com" + d.arcurl, target: "_blank"}, d.title)), 
							React.DOM.p(null, d.description), 
							React.DOM.p({className: "success", ref: "sid-" + d.sid})	
						)
					))
				}
			},this)
