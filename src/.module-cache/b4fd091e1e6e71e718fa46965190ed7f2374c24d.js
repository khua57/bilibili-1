...
var SearchBar = React.createClass({displayName: 'SearchBar',
	...
	render: function(){
		...
		React.DOM.div({className: "row collapse"}, 
			...
			React.DOM.input({type: "text", placeholder: "bilibili...", ref: "searchBar", onInput: this.suggest, onFocus: this.suggest}), 
			SuggestList({value: this.state.suggestList, onClickHandler: this.props.onClickHandler, resetHandler: this.resetHandler})
			), 
