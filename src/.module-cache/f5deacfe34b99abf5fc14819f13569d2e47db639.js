...
var App = React.createClass({displayName: 'App',
	...
	render: function(){
		...
		return (
			React.DOM.div(null, 
				SearchBar({onClickHandler: this.onClickHandler, onChangeHandler: this.onChangeHandler}), 
				Result({value: value, onChangeHandler: this.onChangeHandler})
			)
		)
	}
})
