			...
			data.forEach(function(d){
				if(d.type === 'video'){
					av.push(React.DOM.li({'data-aid': d.aid}, 
						React.DOM.a({className: "th", href: d.arcurl, target: "_blank"}, 
  							React.DOM.img({src: d.pic})
						), 
						React.DOM.div({className: "des"}, 
							React.DOM.h6(null, React.DOM.i({className: "label secondary"}, d.typename), React.DOM.a({href: "", target: "_blank"}, d.title)), 
